...
int main(){
	...
	printf ("\n=====================================================\n");
	printf ("	  RANDOM CARD TEST 2 Village	\n");
	printf ("=====================================================\n");
	...
	for (i = 0; i < NUM_TESTS; i++){
		...
		//village: player gets 1 card in hand from his deck
		...
		//check num of actions, supposed to get +2 after village
		printf ("[Test3] Expected numActions: %d vs. Tested numActions: %d ", G.numActions + 2, testG.numActions);
